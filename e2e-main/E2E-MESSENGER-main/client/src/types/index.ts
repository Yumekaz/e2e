...
export type MessageState = 'pending' | 'delivered' | 'read' | 'deleted';
...
export interface SocketEvents {
  ...
  'screenshot-detected': (data: { roomId: string; username: string }) => void;
  ...
  'message-deleted': (data: { messageId: string; deleteType: DeleteType; deletedBy: string }) => void;
  'screenshot-warning': (data: { username: string }) => void;
